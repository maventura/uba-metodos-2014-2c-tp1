...
This project was developed for a numerical methods course assignment. It provides a high-performance C++ implementation to estimate the internal temperature distribution and specific isotherms within the wall of a cylindrical blast furnace.
